...
function listOfNames(array) {
  ...
  for(let i = 0; i < array.length; i++){
    filteredNames.push(array[i].name)
  }
  return filteredNames
}
console.log(listOfNames('task 4:', artists))
...
console.log('task 6;', addArtist(artists, 'Adrian Perez', '1999-2022', 'Full Stack Development', 'American', `I Have a background is sales and I'm attending Bloomtech to go into programming.`))
